...
const WHY = [
  ...
  { icon: Zap,           title: 'Offers Within 48 Hours',   body: 'Our process connects you directly with hiring managers. Average time from apply to offer: 48 hours.',                accent: '#d97706', bg: '#fffbeb' },
  { icon: GraduationCap, title: 'Skill Certifications',     body: 'Industry-aligned courses with partner-recognised certificates that make your profile stand out.',                    accent: '#7c3aed', bg: '#f5f3ff' },
  { icon: TrendingUp,    title: 'Career Progress Tracking', body: 'Monitor every application, collect structured feedback, and build a verified professional profile.',                 accent: '#059669', bg: '#ecfdf5' },
]
      ...
      <main className="w-full overflow-x-hidden">
        ...
        <section className="relative bg-white overflow-hidden">
          ...
          <div className={`relative ${CONTAINER}`}>
            {/*
              Mobile  : column, items-center, text-center
              lg+     : row, items-center, text-left
            */}
            <div className="flex flex-col items-center text-center lg:flex-row lg:items-center lg:text-left lg:gap-12 xl:gap-16 pt-10 pb-0 lg:pt-14">
              ...
              >
                <div className="inline-flex items-center gap-2 mb-5 border border-indigo-100 bg-indigo-50 rounded-full px-3 py-1.5">
                  ...
                  <span className="text-[10.5px] font-bold text-indigo-700 uppercase tracking-[0.13em]">#1 Platform · MSME Registered</span>
                </div>
                ...
                <h1 className="text-[2.1rem] sm:text-[2.6rem] xl:text-[3rem] 2xl:text-[3.4rem] font-extrabold text-slate-900 leading-[1.07] tracking-tight mb-4">
                  ...
                  <span className="text-slate-400 font-semibold text-[1.3rem] sm:text-[1.55rem] xl:text-[1.8rem]">for ambitious students.</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-8">
                  ...
                  <Link href="/courses" className="w-full sm:w-auto">
                    <button className="w-full inline-flex items-center justify-center gap-2 border-2 border-slate-200 text-slate-700 hover:border-indigo-200 hover:text-indigo-700 px-6 py-3 text-[13.5px] font-bold rounded-xl transition-all bg-white">
          ...
          {/* Metrics strip — 2 cols mobile, 4 cols lg+ */}
          ...
          <div className={CONTAINER}>
            ...
            <FadeUp className="flex flex-col items-center text-center lg:flex-row lg:items-end lg:justify-between lg:text-left gap-4 mb-9">
              <div>
                ...
                <p className="text-slate-500 text-[13.5px] mt-1.5 max-w-sm mx-auto lg:mx-0">Verified roles at India's most trusted startups.</p>
              </div>
